...
Bike.create(make: 'Vespa', :model => 'T', year: '2000', engine: '50cm3', bike_type: 'scooter', rate_daily: 5, bike_image: 'http://www.roadsmile.com/images/an-allnew-vespa-sprint-2015-is-here-to-give-you-joy-ride.jpbike_g')
